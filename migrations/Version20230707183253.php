 ...
 */
final class Version20230707183253 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entreprise ADD nom_entreprise VARCHAR(100) NOT NULL, ADD situation_geographique VARCHAR(100) NOT NULL, DROP raison_social, CHANGE email email VARCHAR(100) NOT NULL, CHANGE addresse addresse VARCHAR(70) NOT NULL, CHANGE type_service type_service VARCHAR(100) NOT NULL, CHANGE date_creation date_creation DATE NOT NULL');
        ...
        $this->addSql('ALTER TABLE startup ADD nom VARCHAR(70) NOT NULL, DROP projet_id_id, DROP nom_startup');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entreprise ADD raison_social VARCHAR(255) NOT NULL, DROP nom_entreprise, DROP situation_geographique, CHANGE email email VARCHAR(255) NOT NULL, CHANGE addresse addresse VARCHAR(255) NOT NULL, CHANGE type_service type_service VARCHAR(255) NOT NULL, CHANGE date_creation date_creation VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE startup ADD projet_id_id INT NOT NULL, ADD nom_startup VARCHAR(255) NOT NULL, DROP nom');
